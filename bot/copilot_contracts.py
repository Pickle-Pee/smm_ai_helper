"""Client-side mirror of copilot_api.v1 (schema parity is regression-tested).

Keep transport values local: importing the backend Copilot package initializes
planning/registry imports. The bot must depend only on the public wire contract.
"""
